!(function (o, r, p) {
  ...
  if (
    (p(o).scroll(function () {
      var e;
      60 < (e = p(o).scrollTop())
        ? p("body").addClass("navbar-scrolled")
        : p("body").removeClass("navbar-scrolled"),
        20 < e
          ? p("body").addClass("page-scrolled")
          : p("body").removeClass("page-scrolled");
    }),
    p(o).on("load", function () {
      ...
      !1 === p.app.nav.initialized && p.app.nav.init({ speed: 300 }),
        ...
        0 < p(".navbar-hide-on-scroll").length &&
          (p(".navbar-hide-on-scroll.fixed-top").headroom({
            offset: 205,
            tolerance: 5,
            classes: {
              initial: "headroom",
        ...
        p(".char-textarea").on("keyup", function (e) {
          !(function (e, a) {
            ...
            p(".char-count").html(e.value.length),
              e.value.length > n
                ? (p(".counter-value").css("background-color", u),
  ...
  p(".bookmark-wrapper .bookmark-star").on("click", function (e) {
      ...
      if (38 !== e.keyCode && 40 !== e.keyCode && 13 !== e.keyCode) {
        ...
        if (
          ...
          var l = "",
            ...
            d = "",
            u = 0;
          p.getJSON("../../../assets/data/" + h + ".json", function (e) {
            for (var a = 0; a < e.listItems.length; a++) {
              ...
              ((0 == e.listItems[a].name.toLowerCase().indexOf(s) && u < 10) ||
    ...
    p(r).on("click", ".bookmark-input .search-list .bookmark-icon", function (
      e
    ) {
